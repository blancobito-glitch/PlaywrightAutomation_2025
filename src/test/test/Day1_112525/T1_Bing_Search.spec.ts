...
test('Capture Search', async () => {
    ...
    let searchResults = await page.locator('[class="sb_count"]').textContent()//you can also use .innerText() //basically GetText()
    //you can use comma , or +
